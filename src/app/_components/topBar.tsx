...
export function TopBar() {
    return (
        <div className="hidden w-[100rem] md:flex justify-between items-center absolute top-0 left-80 pl-16 py-4 bg-gray-100 shadow">
            <div className="flex items-center">
                <span className="text-4xl font-bold">ROAST NOMADS</span>
            </div>
            <div className=" h-8 flex items-center space-x-4 px-52">
